...
/**
 * The mod_quiz continue attempt event.
 *
 * @package    mod_quiz
...
/**
 * The mod_quiz continue attempt event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_continue extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcontinueattempt', 'mod_quiz');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has continued the attempt with id " .
