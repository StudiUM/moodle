...
class behat_calendar extends behat_base {
     ...
     * @param string $optionvalue the label of the option
     * @throws Exception
     * @return void
     */
    public function i_choose_from_the_course_selector($optionvalue) {
        ...
        if ($selectfield === null) {
            throw new \Exception(
                sprintf(
                    'The select "%s" was not found in page %s',
                    $select,
        ...
        if ($optionfield === null) {
            throw new \Exception(
                sprintf(
                    'The option %s was not found in the %s select in page %s',
                    $optionvalue,
                    $select,
                    $this->getSession()->getCurrentUrl()
                )
    ...
    public function i_should_see_that_the_option_from_select_is_not_available($optionvalue) {
        ...
        if ($optionfield !== null) {
            throw new \Exception(
                sprintf(
                    'The option %s was found in the %s select in page %s',
                    $optionvalue,
                    $select,
                    $this->getSession()->getCurrentUrl()
                )
